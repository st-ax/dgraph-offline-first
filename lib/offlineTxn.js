...
exports.OfflineTxn = void 0;
var errors_1 = require("./errors");
var util_1 = require("./util");
var is_online_1 = require("is-online");
var OfflineTxn = (function () {
    function OfflineTxn(dc, options) {
    ...
    OfflineTxn.prototype.isOnline = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, is_online_1.default()];
                    case 1: return [2, _a.sent()];
                }
            });
        });
    };
    OfflineTxn.prototype.query = function (q, options) {
        return this.queryWithVars(q, undefined, options);
    };
    OfflineTxn.prototype.queryWithVars = function (q, vars, options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
    ...
    OfflineTxn.prototype.mutate = function (mu) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.isOnline()];
                    case 1:
                        if (_a.sent()) {
                            console.log("offline txn online running mutation...");
                            return [2, this.dcTxn.mutate(mu)];
                        }
                        else {
                            console.log("offline txn isOffline saving mutation to queue");
                            return [2, this.dcTxn.mutate({})];
                        }
                        return [2];
                }
            });
    ...
    OfflineTxn.prototype.commit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var c, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        e_1 = _a.sent();
                        throw util_1.isAbortedError(e_1) ? errors_1.ERR_ABORTED : e_1;
                    case 4: return [2];
                }
            });
        });
    };
    OfflineTxn.prototype.discard = function () {
        return __awaiter(this, void 0, void 0, function () {
            var c;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    OfflineTxn.prototype.mergeArrays = function (a, b) {
        var res = a.slice();
        res.push.apply(res, b);
        res.sort();
        return res.filter(function (item, idx, arr) { return idx === 0 || arr[idx - 1] !== item; });
    };
    OfflineTxn.prototype.mergeContext = function (src) {
        if (src === undefined) {
            return;
        }
